package org.platform.modules.kyfw.service.impl;

import org.platform.modules.kyfw.crawler.KyfwHandler;
import org.platform.modules.kyfw.crawler.KyfwS01LoginInit;
import org.platform.modules.kyfw.crawler.KyfwS02CaptchaImage;
import org.platform.modules.kyfw.crawler.KyfwS03CaptchaCheck;
import org.platform.modules.kyfw.crawler.KyfwS04Login;
import org.platform.modules.kyfw.crawler.KyfwS08AuthUamtk;
import org.platform.modules.kyfw.crawler.KyfwS10LeftTicket;
import org.platform.modules.kyfw.crawler.KyfwS12SubmitOrderRequest;
import org.platform.modules.kyfw.crawler.KyfwS14ConfirmPassengerInitDc;
import org.platform.modules.kyfw.crawler.KyfwS15GetPassengers;
import org.platform.modules.kyfw.crawler.KyfwS16CheckOrderInfo;
import org.platform.modules.kyfw.crawler.KyfwS18GetQueueCount;
import org.platform.modules.kyfw.crawler.KyfwS20ConfirmSingleForQueue;
import org.platform.modules.kyfw.crawler.KyfwS22QueryOrderWaitTime;
import org.platform.modules.kyfw.crawler.KyfwS24ResultOrderForDcQueue;
