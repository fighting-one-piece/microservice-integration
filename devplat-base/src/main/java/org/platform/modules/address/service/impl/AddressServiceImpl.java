package org.platform.modules.address.service.impl;
...
import org.platform.modules.address.entity.ADMatcher;
import org.platform.modules.address.entity.ADMatcherItem;
import org.platform.modules.address.entity.ADMatcherType;
import org.platform.modules.address.entity.AdministrativeDivisionMatcher;
...
public class AddressServiceImpl implements IAddressService, InitializingBean {
	...
	private void getParentAdministrativeDivision(String region, List<String> parents, int level) {
		if (level == 0) return;
		parents.add(region);
