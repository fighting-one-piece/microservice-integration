...
public class HttpProxyUtils {
	...
	public static String sendGet(String url, Map<String, String> params, String encode, int connectTimeout,
			int soTimeout, String... headers) throws ClientProtocolException, IOException {
	 ...
	 */
	public static String sendGet(String url, Map<String, String> params, String encode, int connectTimeout,
			int soTimeout, HttpHost proxy, String... headers) throws ClientProtocolException, IOException {
		String responseTxt = null;
		RequestConfig.Builder builder = RequestConfig.custom().setSocketTimeout(connectTimeout)
	...
	public static boolean sendGetWithVerifyProxy(String url, Map<String, String> params, String encode,
			int connectTimeout, int soTimeout, HttpHost proxy) throws ClientProtocolException, IOException {
		RequestConfig.Builder builder = RequestConfig.custom().setSocketTimeout(connectTimeout)
				.setConnectTimeout(connectTimeout).setConnectionRequestTimeout(connectTimeout);
		if (null != proxy)
			builder.setProxy(proxy);
