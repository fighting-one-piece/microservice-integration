...
import org.cisiondata.modules.elastic.service.IElastic2Service;
...
public class Elastic2ServiceImpl extends Elastic2AbstractServiceImpl implements IElastic2Service {
	...
	private SearchRequestBuilder buildSearchRequestBuilder(String qindex, String[] qtypes) {
		return Elastic5Client.getInstance().getClient().prepareSearch(
...
//        }
	...
	private QueryResult<Map<String, Object>> readPaginationDataList(String index, String[] types,
		...
		if (StringUtils.isNotBlank(scrollId)) {
			response = Elastic5Client.getInstance().getClient().prepareSearchScroll(scrollId)
